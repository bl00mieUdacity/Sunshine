...
public class DetailActivity extends ActionBarActivity {
    ...
    public static class DetailFragment extends Fragment implements LoaderCallbacks<Cursor> {
        ...
        public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
            ...
            String h = Utility.formatTemperature(data.getDouble(COL_WEATHER_MAX_TEMP), metric);
            String l = Utility.formatTemperature(data.getDouble(COL_WEATHER_MIN_TEMP), metric);
            mForecastStr = String.format("%s - %s - %s/%s", dateStr, desc, h, l);
